		...
		?>
					<h1>Hohenheimer Einfachbeute, Zander</h1>
					<aside>
						<h3>Benötigtes Material</h3>
						<ul style="margin: 10px 0 0 20px;">
							<li><b>2 oder 4 Leimholzplatten</b> 2000*400*18mm: 8,49€ (Bauhaus)</li>
							<li><b>Schrauben</b> Edelstahl (5,0 x 50); 200Stk: 18,99€ (OBI)</li>
							<li><b>Leim</b> wasserfest</li>
							<li><b>Tacker oder Nägel</b> mit breitem Kopf</li>
							<li><b>2 Voreiber</b>: je 0,30€</li>
							<li><b>Edelstahlgitter</b>: 4,70€ (von Wachs Hödl, "Wandergewebe")</li>
							<li><b>Sperrholz</b></li>
							<li><b>Leiste Griff Varroalade </b></li>
							<li><b>(8 Leisten</b> 5*5*380 mm, wenn Rähmchen kurze Ohren haben) </li>
							<li><b>(Leiste</b> 3*20*380 mm, wenn Putzkeil gebaut werden soll) </li>
							<li><b>(Scharniere</b> nicht rostend f. Deckel)</li>
							<li><b>(Anstrich</b> speziell für Bienenbeuten)</li>
							
						</ul>
					</aside>
					<p>
						Der Bauplan ist für die in Baumärkten für gewöhnlich erhältlichen 18mm Platten adaptiert (Der Originalbauplan ist für 20mm-Platten) und mit der freien (und kostenlosen) Software <a href="http://www.freecadweb.org/" target="_blank">FreeCAD</a> konstruiert. 
						<br /><br />
						...
						<br /><br />
						<ul>
							<li>Konstruktionszeichnung in FreeCAD: <a href="cad/Konstruktion-Hohenheimer-Einfachbeute-2017-04-24.fcstd">DOWNLOAD</a></li>
							<li>Konstruktionszeichnung in FreeCAD f. Bauhaus: <a href="cad/Hohenheimer_Einfachbeute_Bauhaus_2018_05_31.fcstd">DOWNLOAD</a></li>
						</ul>
						<br /><br />
						DOWNLOAD des Schnittplans: 
						<ul>
						...
						[Achtung: Im PDF der Standard-Bauweise sind auch die Platten fürs Dach usw. eingezeichnet, diese fehlen im Bild]
						<br /><br />
						Für 2000*400*18mm Platten. Der Schnittplan ergibt einen (hohen) Boden, vier Zargen, eine Futterzarge und ein Dach.
						<br /><br />
						Wichtig ist laut der Anleitung des <a href="http://www.imkerverein-gaggenau.de/bauanleitungen/" target="_blank">Imkerverein Gaggenau</a> "die Verleimart, die nach EN 204 die Klasse D3 oder D4 haben sollte."
						<br /><br />
						...
						<ul style="margin: 5px 0 10px 30px;">
							<li><a href="Ansicht1.html">Ganze Beute (3,6 MB)</a></li>
							<li>Weitere Ansichten folgen!</li>
						</ul>
						Innerhalb der WebGL-Ansicht kann mit der linken Maustaste gedreht werden, mit der mittleren (geklickt, NICHT scrollen) gezoomt und mit der rechten das Objekt bewegt werden. <b>Nicht</b> für Touchgeräte geeignet!
						...
						<h2>Zusammenbauen</h2>
						<p>
							<b>Einkauf der Holzbauteile:</b> In Baumärkten gibt es häufig die Möglichkeit, sich Holz(platten) nach Plan zuschneiden zu lassen. Dadurch erhält man praktisch einen Bausatz für Beuten, nur viel günstiger. Je nach Holzqualität und Baumarkt gibt es große Preisunterschiede. Ich habe im Mai 2018 8,49€ für eine Platte 2000*400*18mm (Naturwuchs) im Bauhaus bezahlt. Bei Obi waren diese wesentlich teurer.
							<b>Allgemeiner Hinweis bezüglich verschrauben:</b> <br />
						...
						<h3>Boden</h3>
						<img src="img/boden_bunt_bauhaus.png" alt="Hohenheimer Einfachbeute Bauplan Boden Ansicht, bunt" class="img-fullwidth">
						<p>
						<br /><br />
						</p>
					...
					<p>
						...
						<ul style="margin-left: 30px;">
							<li>
								<a href="http://www.imkerverein-gaggenau.de/bauanleitungen/">Diese Bauanleitung habe ich als Basis verwendet. Dort stehen erklärende Worte zu benötigter Holzqualität u.ä.</a>
							</li>
							<li>
						...
						<br />
						<br /><br />
						<img src="img/1.png" alt="Hohenheimer Einfachbeute Bauplan Ansicht" class="img-fullwidth">
						Seitenansicht
						<br /><br />
						<img src="img/2.png" alt="Hohenheimer Einfachbeute Bauplan Ansicht" class="img-fullwidth">
						Zarge mit Rähmchen
						<br /><br />
						<img src="img/3.png" alt="Hohenheimer Einfachbeute Bauplan Ansicht" class="img-fullwidth">
						Zarge ohne Rähmchen
						<br /><br />
						<img src="img/4.png" alt="Hohenheimer Einfachbeute Bauplan Ansicht" class="img-fullwidth">
						Boden mit Varroalade
						<br /><br />
						<img src="img/5.png" alt="Hohenheimer Einfachbeute Bauplan Ansicht" class="img-fullwidth">
						Boden ohne Varroalade
						<br /><br />
						<img src="img/6.png" alt="Hohenheimer Einfachbeute Bauplan Ansicht"  class="img-fullwidth">
						Durchsicht (Querteile ausgeblendet)
						<br /><br />
						<img src="img/7.png" alt="Hohenheimer Einfachbeute Bauplan Ansicht"  class="img-fullwidth">
