		...
		?>
					...
					<p>
						...
						Bienenzucht Wien</a>.<br /><br />
						Von 14.02. - 11.05. absolvierte ich dann also einen Grundkurs für Imkerei. Dieser fand in der HTL Donaustadt statt, da sich die Imkerschule im Umbau befand.
						<br />
					...
					<p>
						...
						<br /><br />
						Momentan besitze ich noch keine Beuten (Jene Holzbehälter, in denen Bienen wohnen), daher stelle ich die Kartonschachtel auf den zukünftigen Platz auf und schütze sie mit Ziegeln und einer Holzplatte vor etwaigen Regenschauern. Meine Bienen stehen beim <a href="http://www.imkerverein.at/bienen-am-zentralfriedhof/" target="_blank"> Bienenzuchtverein Wien Ortsgruppe 1 am Zentralfriedhof</a>.
						<br /><br />
						
						<img src="img/ankauf-small.jpg" alt="Ausflugloch für Bienen aus Ankaufskarton"  class="img-fullwidth">
						Damit die Bienen auch heraus können schneide ich eine kleine Flugöffnung in die Seite der Schachtel.
						<br /><br />
						<img src="img/ankauf2-small.jpg" alt="Karton aufgestellt und mit Ziegeln vor Regen geschützt"  class="img-fullwidth">
					...
					<p>
						...
						<br /><br />
						<img src="img/waben-naturbau-small.jpg" alt="Naturbau aus dem Karton"  class="img-fullwidth">
						Die Bienen waren bereits fleißig und haben einige Waben gebaut. Leider passen diese nicht in die Rähmchen und werden daher zum Einschmelzen mitgenommen. Irgendwann erzeuge ich daraus einmal neue Mittelwände. Die schwarzen Waben sind mit Pollen von Mohn gefüllt.
						<br /><br />
						<img src="img/eier-small.jpg" alt="Eier in den neu gebauten Waben"  class="img-fullwidth">
						Auch die Königin hat bereits begonnen Eier zu legen. Sie sind als die kleinen weißen Stifte am Boden der Waben zu erkennen.
					</p>
