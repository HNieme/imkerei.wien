		...
		?>
					...
					<p><br /><br /></p>
					<h3 id="10.03"><a href="#10.03" >10. März</a></h3>
					<p>
						Endlich kommt der Frühling! Es ist angenehm warm und die Bienen der meisten Völker am <a href="http://www.imkerverein.at/wintercheck-am-bienenstand-am-zentralfriedhof/" target="_blank">Vereinsbienenstand</a> sammeln schon fleißig Pollen. Bei meinen zwei ist zwar nicht ganz so viel Flugbetrieb, doch immerhin ist vorerst noch ausreichend Futter da. Erst ab nächster Woche sollte ich ein wenig zufüttern.
						
						<br /><br />
						<img src="img/2018_03_10_flugbetrieb-small.jpg" alt="Reger Flugbetrieb, bienen mit Pollenhöschen beladen"  class="img-fullwidth">
						...
						<br /><br />
						<img src="img/2018_03_10_blick-putzkeil-small.jpg" alt="Blick in den Putzkeil"  class="img-fullwidth">
						...
						<br /><br />						
						<img src="img/2018_03_10_bienen-zwischen-rähmchen-small.jpg" alt="Blick von oben zwischen die Rähmchen"  class="img-fullwidth">
						<br /><br />						
						Auch von oben können die Bienen durch die Kunststofffolie, mit der die Rähmchen abgedeckt sind, beobachtet werden.
						<br /><br /><br />
					</p>
					<h3 id="17.03"><a href="#17.03" >17. März</a></h3>
					<p>
					...
					<h3 id="07.04"><a href="#07.04" >Samstag, 7. April</a></h3>
					<p>
