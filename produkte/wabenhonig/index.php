		...
		?>
			<img src="img/wabenhonig_großer_rahmen_small.jpg" alt="Wabenhonig im Rahmen"  class="img-fullwidth">
			<p>
				<br />
				<br />
			</p>
			...
			<p>
				<br />
				Die Leisten werden von Hand zugesägt, genagelt, etwas geschliffen und oben mit einem Bienenwachsstrich versehen, an dem die Bienen den Wabenbau beginnen können. Anschließend werden die kleinen Rähmchen in größere Rähmchen eingepasst, die dann ins Bienenvolk gehängt werden. 
				<br />
